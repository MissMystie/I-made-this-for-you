...
namespace Mystie.UI
{
    public class UIManager : MonoBehaviour
    {
        ...
        public void SetState(UIState newState)
        {
            ...
            //if (showDebug) Debug.Log(GetStateStackString());
        }
        ...
        public void CloseState(bool immediate = false)
        {
            ...
            if (CurrentState != null) StartCoroutine(CurrentState.DisplayState());
        ...
        public void OnPause(CallbackContext ctx) { Pause(); }

        public void Pause() { if (IsInputBuffer) CurrentState?.Pause(); }
